...
interface AddLinkPayload { parentLink: string, playableLink: string, headers: Record<string, string>, imdbId: string, title: string, contentType?: string, size: number, speedRank: number }
